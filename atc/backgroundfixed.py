...
def generate_bg():
    ...
    junction_center = np.array([100,50])
    ...
    b_g['goal'] = np.array([[junction_center[0]-runway_width/2,junction_center[0]+runway_width/2] + noise_epistemic[0],[g_height-goal_size,g_height-goal_size] + noise_epistemic[1]])
    ...
    flight_left_x = 0 + flight_left_size/2 + 10
    flight_left_y = junction_center[1]
    ...
    flight_right_x = g_width - flight_right_size/2 -10
    flight_right_y = junction_center[1]
